...
for(i in 26:length(chunks)){
  ...
  saveRDS(mat_sub, paste0("data/ttmatrix/ttmatrix_car_chunk_",i,"_from_",min(chunk_sub),"_to_",max(chunk_sub),".Rds"))
  rm(otpcon, mat_sub)
